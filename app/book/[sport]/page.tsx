...
export default async function SportConfigPage({
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      ...
      {/* Pickleball launch promo banner. Same 3:1 PNG used on the
          landing page above the sports grid — single source of truth
          for the discount copy + pricing so we don't have to keep two
          surfaces (text card + image) in sync. Generated by
          scripts/generate-pickleball-banner.py. */}
      {sportKey === "PICKLEBALL" && (

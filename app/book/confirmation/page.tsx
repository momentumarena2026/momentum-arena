...
// DLT-whitelistable (Airtel requires query-string-based dynamic URLs).
// The legacy path /book/confirmation/<bookingId> redirects here for
// backward compatibility with links already sent over SMS/email.
export default async function ConfirmationPage({
  ...
  // sizeInfo is read to surface the court size metadata where needed later.
  void sizeInfo;

 ...
 * checkout, order detail). Mirrors /book/layout.tsx so the header
 * + user chip stay consistent across the funnel. Without this the
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <Link
                href="/shop"
                className="hidden md:flex text-sm font-medium text-emerald-400 transition"
              >
                🛍️ Shop
              </Link>
            </div>

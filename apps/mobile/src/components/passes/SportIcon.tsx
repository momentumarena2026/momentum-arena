...
/**
 * Sport glyphs for the pass cards — the EXACT Material Design paths the
 * web storefront renders via react-icons (MdSportsCricket /
 * MdSportsSoccer / MdSportsTennis), re-drawn with react-native-svg so
 * the tiles match web pixel-for-pixel and tint in the sport accent
 * (emoji glyphs don't tint and looked off in the tinted tile).
 */
export function SportIcon({
  ...
  // CRICKET (also the bowling-machine variant)
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>

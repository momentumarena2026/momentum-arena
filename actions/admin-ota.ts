 ...
 *
 * requireAdmin resolves the caller from either the web cookie session or the
 * mobile bearer JWT, so the mobile admin route (app/api/mobile/admin/ota) can
 * reuse this query directly — no auth bypass needed.
 */

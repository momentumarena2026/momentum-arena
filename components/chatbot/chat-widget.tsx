    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-20 md:bottom-16 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-emerald-600 shadow-lg shadow-emerald-900/30 transition-all hover:bg-emerald-700 hover:scale-110"
      ...
      {/* Chat Panel */}
      {isOpen && (
        <div className="fixed bottom-20 md:bottom-16 right-6 z-40 flex h-[500px] w-[360px] flex-col overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950 shadow-2xl shadow-black/50 sm:w-[380px]">
          {/* Header */}
